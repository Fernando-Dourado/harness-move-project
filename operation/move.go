...
func (o *Move) Exec() error {
	...
	operations = append(operations, services.NewFileStoreOperation(&sourceApi, &targetApi, st))
	operations = append(operations, services.NewEnvironmentOperation(&sourceApi, &targetApi, st))
